      ...
      <div className="bg-discord-sidebar rounded-2xl shadow-2xl p-8 max-w-md w-full mx-4 border-2 border-discord-blurple/20 animate-scaleIn">
        ...
        <div className="text-center mb-6">
          <div className="inline-flex items-center justify-center w-20 h-20 mb-6">
            <img src="/upg.png" alt="UPG Logo" className="w-full h-full object-contain" />
          </div>
          <h2 className="text-3xl font-bold text-white mb-2">┬íBienvenido a UPG!</h2>
          <p className="text-gray-400 text-sm">
            Inicia sesi├│n con tu cuenta de Discord para continuar
          </p>
        </div>
        ...
        <div className="mt-6 p-4 bg-discord-chat rounded-lg border border-gray-700">
          <p className="text-xs text-gray-400 text-center">
            Al iniciar sesi├│n, usaremos tu nombre de usuario y foto de perfil de Discord. No
            almacenamos tus datos, se cargan directamente desde Discord.
          </p>
        </div>

        {/* Footer */}
        <p className="text-xs text-gray-500 text-center mt-6">
          Necesitas una cuenta de Discord para usar UPG
        </p>
      </div>
    </div>
  );
