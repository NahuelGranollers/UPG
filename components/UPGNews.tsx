...
const UPGNews: React.FC = () => {
  const articles: NewsArticle[] = [
    {
      ...
      excerpt: 'Implementamos un panel de administración avanzado para mantener la comunidad segura.',
      author: 'AdminZero',
      date: '2025-11-24',
      category: 'update',
      readTime: 2
    },
    {
      ...
      excerpt: '¡Prepárense! El torneo mensual de Valorant comienza el 1 de diciembre con premios de $500.',
      author: 'ModLuna',
      date: '2025-11-23',
      category: 'tournament',
      readTime: 3
    },
    {
      ...
      excerpt: 'Nueva función experimental: transforma mensajes de usuarios objetivo. ¡Solo para admins!',
      author: 'DevKai',
      date: '2025-11-22',
    ...
    },
    {
      ...
      excerpt: 'Únete a nuestra game night semanal este viernes. Juegos variados para todos los niveles.',
      author: 'ComMgr',
      date: '2025-11-21',
      category: 'event',
      readTime: 2
    },
    {
      ...
      excerpt: 'Mejoramos la calidad de audio y añadimos indicadores de latencia en canales de voz.',
      author: 'DevKai',
      date: '2025-11-20',
      category: 'update',
      readTime: 2
  ...
  return (
    <div className="flex-1 bg-discord-chat overflow-y-auto custom-scrollbar">
      <div className="max-w-4xl mx-auto p-4 sm:p-6 md:p-8">
        ...
        <div className="text-center mt-8">
          <button className="discord-button secondary px-8 py-3">
            Cargar más noticias
          </button>
        </div>
      </div>
