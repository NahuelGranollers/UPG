    ...
    <Modal isOpen={isOpen} onClose={onClose} title="Editar perfil" size="md">
      <div className="space-y-4">
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <div className="text-xs text-discord-text-muted">
                Vincula o desvincula tu cuenta de Discord para integración
              </div>
            </div>
            <div>
              {isGuest ? (
                <button
                  ...
                  className="bg-discord-blurple text-white px-3 py-1 rounded"
                >
                  Vincular
                </button>
              ) : (
        ...
        <div className="flex items-center justify-end gap-2 pt-4">
          <button onClick={onClose} className="px-3 py-1 rounded border border-gray-700 text-sm">
            Cancelar
          </button>
          <button
            onClick={handleSave}
            className="px-3 py-1 rounded bg-discord-blurple text-white text-sm"
          >
            Guardar
          </button>
        </div>
