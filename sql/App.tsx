...
const MOCK_USERS: User[] = [
  ...
  { id: 'bot', username: 'UPG Bot', avatar: 'https://api.dicebear.com/7.x/bottts/svg?seed=UPG', status: 'online', isBot: true, color: '#5865F2' },
...
function App() {
  ...
  }, [currentUser]); // Run once on mount (depend on currentUser stable ID)
  ...
  useEffect(() => {
    ...
    return () => bc.close();
  }, [activeVoiceChannel, currentUser.id]);
